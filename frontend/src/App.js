...
//      setBackendStatus(data.chatbot_ready ? "Connected" : "Bot Not Ready");
//    } catch (err) {
//      setBackendStatus("Backend Down");
//    }
//  };
//
//  // ------------------ SHOW EMAIL UI ------------------
...
//
//    // remove earlier email card
//    setMessages((prev) => prev.filter((m) => m.type !== "email_card"));
//
//    const id = `email_card_${Date.now()}`;
//
//    setMessages((prev) => [
//      ...prev,
//      {
...
//
//  // ------------------ STREAM FUNCTION ------------------
//  const startStream = async (message, isRetry = false, overrideEmail = null) => {
...
//      ]);
//    } else {
//      // retry adds only bot placeholder
//      setMessages((prev) => [
//        ...prev,
//        { id: botId, role: "bot", content: "", streaming: true },
//      ]);
...
//          }
//
//          // ❗ Backend asking for email
//          if (data.require_email) {
//            // stop showing typing placeholder
...
//
//      if (!data.success) {
//        setEmailError(data.message || "Failed");
//        return;
//      }
//
...
//
//      if (retryQuery) {
//        setTimeout(() => startStream(retryQuery, true, savedEmail), 100);
//      }
//    } catch {
//      setEmailError("Error");
//    }
...
//      setMessages((prev) => prev.filter((m) => m.type !== "email_card"));
//
//      if (retryQuery) setTimeout(() => startStream(retryQuery, true), 100);
//    } catch {
//      setEmailError("Error");
//    }
//  };
...
//    setEmailInput("");
//    setEmailError("");
//    setMessages([]); // this clears display
//  };
//
//  // ------------------ RENDER ------------------
...
//    if (msg.role === "user") {
//      return (
//        <div key={msg.id} style={{ textAlign: "right", marginBottom: 12 }}>
//          <div style={{ background: "#667eea", color: "white", padding: 10, borderRadius: 10, display: "inline-block" }}>
//            {msg.content}
//          </div>
//        </div>
//      );
...
//          <div style={{ background: "#5a3ecf", color: "white", padding: 16, borderRadius: 12 }}>
...
//                style={{ flex: 1, padding: 10, borderRadius: 8, border: "1px solid #aaa" }}
//              />
//              <button onClick={handleEmailSubmit} style={{ padding: "10px 16px", borderRadius: 8, background: "white", color: "#5a3ecf" }}>
//                Submit
//              </button>
//
//              {msg.skipAllowed && (
//                <button onClick={handleEmailSkip} style={{ padding: "10px 16px", borderRadius: 8, background: "rgba(255,255,255,0.2)" }}>
//                  Skip
//                </button>
//              )}
//            </div>
//
//            {emailError && <div style={{ marginTop: 8, color: "#ffb3b3" }}>{emailError}</div>}
//          </div>
//        </div>
//      );
//    }
...
//        <div style={{ background: "white", padding: 12, borderRadius: 10, display: "inline-block" }}>
//          {msg.content}
//        </div>
//      </div>
//    );
...
//      <h2>SRMIST Chatbot</h2>
//      <p>Status: {backendStatus}</p>
//
//      <div style={{ height: 500, overflowY: "auto", background: "#f5f5f5", padding: 20, borderRadius: 10 }}>
...
//        />
//        <button onClick={sendMessage} disabled={loading} style={{ padding: "12px 20px", borderRadius: 8 }}>
//          Send
//        </button>
//        <button onClick={clearChat} style={{ padding: "12px 20px", borderRadius: 8 }}>
//          Clear
//        </button>
//      </div>
//    </div>
