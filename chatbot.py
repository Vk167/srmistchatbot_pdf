# """
# University RAG Chatbot core functionality
# """
# import re
# import json
# import random
...
#         num_sources = random.randint(1, min(3, len(scored_docs)))
#         selected_docs = [doc for score, doc in scored_docs[:num_sources]]
#
#         sources_info = "**For more details, check these sources:** \n"
...
#             If stream=True: Generator yielding (partial_answer, sources_or_empty)
#         """
#         try:
#             if not question or not question.strip():
#                 result = "Please ask a question about the university."
#                 if stream:
#                     yield result, ""
#                     return
#                 return result, ""
...
#                 result = "Please keep your questions under 1000 characters."
#                 if stream:
#                     yield result, ""
#                     return
#                 return result, ""
...
#             )
#             if is_greeting:
#                 result = random.choice(GREETING_RESPONSES)
#                 if stream:
#                     yield result, ""
#                     return
#                 return result, ""
...
#                     accumulated_answer, context, filtered_docs, question
#                 )
#                 sources_info = (
#                     self._format_sources(filtered_docs) if should_show_sources else ""
#                 )
#                 yield accumulated_answer, sources_info
#                 return
#
#             # Non-streaming mode
